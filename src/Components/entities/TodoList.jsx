  ...
  return (
    <div className="w-full flex flex-col items-center">
      <div className="container absolute bottom-[-45px] sm:bottom-[-40px]">
        <div
          className={`flex items-center justify-between md:py-[40px!important] py-[49px!important] sm:py-[60px!important] rounded-2xl px-4 bg-white w-full transition ease-linear duration-700 ${
        ...
        >
          <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-5 gap-x-3 sm:gap-x-5 gap-y-3 sm:gap-y-5">
